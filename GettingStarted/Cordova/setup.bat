...
set AZME_ANDROID_COLLECTION=<YOUR SDK KEY>

set AZME_ANDROID_REACH_ICON_ANDROID=icon
...
call cordova plugin add cordova-plugin-ms-azme  --variable AZME_ANDROID_APPID=%AZME_ANDROID_APPID% ^
									...
									--variable AZME_ANDROID_REACH_ICON_ANDROID=%AZME_ANDROID_REACH_ICON_ANDROID% ^
